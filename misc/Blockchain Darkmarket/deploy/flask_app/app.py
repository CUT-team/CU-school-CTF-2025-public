        ...
        for container_data in containers:
            try:
                ...
                try:
                    ...
                    logger.error(
                        f"Error removing container {container_id}: {container_error}"
                    )
                ...
                logger.error(
                    f"Failed to process container cleanup for {container_data}: {e}"
                )
...
if __name__ == "__main__":
    ...
    logger.info(
        f"Starting Flask application (debug={debug_mode}, reloader={use_reloader})"
    )
